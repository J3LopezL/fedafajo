...
describe("Create Tag", () => {
  beforeEach(async () => {
    ...
    //   path: `../Results/Puppeteer/v3.42.5/CreateTag/initialPage.jpg`,
    // });
    await navigationPage.login(page, config.user, config.password);
    // await page.screenshot({
    //   path: `../Results/Puppeteer/v3.42.5/CreateTag/home.jpg`,
    // });
  });
  ...
  afterEach(async () => {
    ...
    // await page.screenshot({
    //   path: `../Results/Puppeteer/v3.42.5/CreateTag/logout.jpg`,
    // });
  });
